;;; use-autocomplete.el --- Initialize auto complete mode -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
...
(use-package auto-complete
  ...
  (defun setup-ac-for-haml ()
    (use-package ac-haml :ensure t)
    (use-package ac-html-default-data-provider :ensure t)
