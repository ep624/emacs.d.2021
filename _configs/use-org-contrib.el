...
'(org-preview-latex-process-alist
  '((dvipng :programs ("latex" "dvipng") :description "dvi > png"
            ...
            ("/usr/local/texlive/2024/bin/x86_64-linux/latex -interaction nonstopmode -output-directory %o %f")
    ...
    (imagemagick :programs ("latex" "convert") :description
                 ...
                 :image-size-adjust (1.0 . 1.0) :latex-compiler
                 ("/usr/local/texlive/2024/bin/x86_64-linux/pdflatex -interaction nonstopmode -output-directory %o %f")
                 :image-converter
                 ("convert -density %D -trim -antialias %f -quality 100 %O"))))

(setq org-latex-pdf-process
      '("/usr/local/texlive/2024/bin/x86_64-linux/xelatex -interaction nonstopmode -output-directory %o %f"
        "/usr/local/texlive/2024/bin/x86_64-linux/biber %b"
        "/usr/local/texlive/2024/bin/x86_64-linux/xelatex -interaction nonstopmode -output-directory %o %f"
        "/usr/local/texlive/2024/bin/x86_64-linux/xelatex -interaction nonstopmode -output-directory %o %f"))
